...
class PowerOfLove(Song):
    bpm = 122

    def notes(self):
        return [
            Note(NoteLength.EIGHT, NoteType.HARP_A, 1, False),
            Note(NoteLength.EIGHT, NoteType.HARP_F, 1, False),
            Note(NoteLength.EIGHT, NoteType.HARP_C1, 1, False),
